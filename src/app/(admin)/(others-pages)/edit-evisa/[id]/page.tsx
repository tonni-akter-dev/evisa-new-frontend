...
const EditEVisa = () => {
  ...
  useEffect(() => {
    ...
    const fetchVisa = async () => {
      try {
        ...
        setPreview(data.data.photo); // show previous image
      } catch {
  ...
  return (
    <div className="flex justify-center py-10 px-4">
      ...
      >
        <h2 className="text-2xl font-bold">Edit EVisa</h2>
